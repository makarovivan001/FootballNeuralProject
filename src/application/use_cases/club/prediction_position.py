...
class LineupProbabilityCalculator:
    """
    Алгоритм расчёта вероятности стартового состава футбольной команды
    на основе статистики игроков, прошлых матчей и ошибок в расстановке.
    """

    # Константы для позиционных категорий
...
def predict_lineup_probability(club_id: int, proposed_squad: List, game_id: int):
    # Получаем последние 11 игр клуба
    ...
    return calculator.calculate_squad_probability(
...
club_id = 32
game_id = 2973
proposed_squad = [[{"id": 695, "position_id": 11}], [{"id": 709, "position_id": 32}, {"id": 701, "position_id": 34}, {"id": 713, "position_id": 36}, {"id": 699, "position_id": 38}], [{"id": 711, "position_id": 63}, {"id": 713, "position_id": 65}, {"id": 714, "position_id": 67}], [{"id": 713, "position_id": 85}], [{"id": 715, "position_id": 104}, {"id": 719, "position_id": 106}]]
prediction = predict_lineup_probability(club_id, proposed_squad, game_id)
